  ...
  _createClass(Pull, [{
    ...
    value: function value(e) {
      ...
      if (isTop) {
        ...
        this.msgWrapStyle[_util2.default.prefix.transform] = 'translate3d(0,' + diffY + 'px, 0)';
        this.contentWrapStyle[_util2.default.prefix.transform] = 'translate3d(0,' + diffY + 'px, 0)';
...
}), _defineProperty(_Util, 'prefix', function () {
...
window.mScroll = require('./index.js');
