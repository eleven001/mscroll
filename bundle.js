...
var Util = (_Util = {
  ...
  */
  ...
  return target;
}), _defineProperty(_Util, 'noop', function noop() {}), _defineProperty(_Util, 'now', Date.now || function () {
  return new Date().getTime();
}), _defineProperty(_Util, 'throttle', function throttle(func) {
  var _this = this,
